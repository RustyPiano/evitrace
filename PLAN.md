...
- [ ] 建表成功；
- [ ] user.username 唯一；
- [ ] evidence 的 `(task_id, display_id)` 唯一；
- [ ] 级联删除逻辑通过服务层实现并测试。
